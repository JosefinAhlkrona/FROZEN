  ...
  DO iter=1,NonlinearIter
     ...
     DO t=1,Solver % NumberOfActiveElements
        ...
        ELSE IF (( ConvectionFlag == 'computed' ) .AND. FlowSolutionFound) THEN
           ...
           !WRITE(*,*) 'max x velo =', MAXVAL(IceVeloU)
           !WRITE(*,*) 'max y velo =', MAXVAL(IceVeloV)
           !WRITE(*,*) 'max z velo =', MAXVAL(IceVeloW)
        ...
        !WRITE(*,*) 'max CT=',MAXVAL(ABS(CT))
	!WRITE(*,*) 'max C0=', MAXVAL(ABS(C0))
	!WRITE(*,*) 'max C1=', MAXVAL(ABS(C1))
	!WRITE(*,*) 'max HeadCond=', MAXVAL(ABS(HeatConductivity))
	!WRITE(*,*) 'max Viscosity=', MAXVAL(ABS(Viscosity))
	!WRITE(*,*) 'max Density=', MAXVAL(ABS(Density))
	!WRITE(*,*) 'max Pressure=', MAXVAL(ABS(Pressure))
